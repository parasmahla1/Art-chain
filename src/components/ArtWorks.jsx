  ...
  return (
    <div className="bg-[#151c25] gradient-bg-artworks">
      <div className="w-4/5 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gaps-6 md:gap-4 lg:gap-3 py-2.5">
          {Array(4)
            .fill()
            .map((nft, i) => (
              <Card key={i} nft={nft} />
...
const Card = ({ nft }) => {
  return (
    <div className="w-full shadow-xl shadow-black rounded-md overflow-hidden bg-gray-800 my-2 p-3">
      <img src={HeroImage} alt="NFT Image" className="h-60 w-full object-cover shadow-lg shadow-black rounded-lg mb-3" />
      ...
      <div className="flex justify-between items-center mt-3 text-white">
        ...
        <button className="shadow-lg shadow-black text-white text-sm bg-[#e32970] hover:bg-[#bd255f] cursor-pointer rounded-full px-1.5 py-1">View Details</button>
      </div>
    </div>
  );
};
